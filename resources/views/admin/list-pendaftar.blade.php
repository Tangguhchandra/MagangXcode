            ...
            button.addEventListener('click', function() {
                ...
                fetch(`/admin/pendaftar/${id}/detail`)
                    ...
                    .then(data => {
                        ...
                        let contentHTML = `
                        <div class="detail-item"><div class="detail-label">Nama:</div><div class="detail-value">${data.nama}</div></div>
                        <div class="detail-item"><div class="detail-label">Email:</div><div class="detail-value">${data.email}</div></div>
                        <div class="detail-item"><div class="detail-label">Jenis Kelamin:</div><div class="detail-value">${data.jenis_kelamin}</div></div>
                        <div class="detail-item"><div class="detail-label">Instansi:</div><div class="detail-value">${data.instansi}</div></div>
                        <div class="detail-item"><div class="detail-label">Divisi:</div><div class="detail-value">${data.divisi}</div></div>
                        <div class="detail-item"><div class="detail-label">Mulai Magang:</div><div class="detail-value">${data.mulai_magang}</div></div>
                        <div class="detail-item"><div class="detail-label">Selesai Magang:</div><div class="detail-value">${data.selesai_magang}</div></div>

                        <div class="detail-item">
                            <div class="detail-label">Foto:</div>
                            <div class="detail-value">
                                ${data.foto ? `<a href="/storage/${data.foto}" target="_blank" class="cv-link">Lihat Foto</a>` : '-'}
                            </div>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                ${data.cv ? `<a href="/storage/${data.cv}" target="_blank" class="cv-link">Lihat CV</a>` : '-'}
                            </div>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                ${data.portofolio ? `<a href="/storage/${data.portofolio}" target="_blank" class="cv-link">Lihat Portofolio</a>` : '-'}
                            </div>
                        </div>
                    `;
